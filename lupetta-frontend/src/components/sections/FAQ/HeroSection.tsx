...
export default function HeroSection() {
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-8 pt-24 sm:pt-28 md:pt-28 pb-20 sm:pb-28 md:pb-28 lg:pb-36 text-center relative z-10 w-full">
