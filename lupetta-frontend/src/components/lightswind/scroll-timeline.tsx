            ...
            <>
              ...
              <motion.div
                ...
                style={{
                  ...
                  boxShadow: `
                    0 0 15px rgba(0,96,113,0.5),
                    0 0 25px rgba(101,179,46,0.3)
                  `,
                }}
              />
              ...
              >
                <motion.div
                  ...
                  style={{
                    background:
                      "radial-gradient(circle, rgba(101,179,46,0.9) 0%, rgba(0,96,113,0.6) 40%, rgba(0,200,160,0) 70%)",
                    // Intense, layered glow effect for the comet
                    boxShadow: `
                      0 0 15px 4px rgba(101, 179, 46, 0.6),
                      0 0 25px 8px rgba(0, 96, 113, 0.4),
                      0 0 40px 15px rgba(0, 200, 160, 0.2)
                    `,
                  }}
                  animate={{
                    scale: [1, 1.3, 1],
                      ...
                      animate={
                        index <= activeIndex
                          ? {
                              scale: [1, 1.3, 1],
                              boxShadow: [
                                "0 0 0px rgba(0,96,113,0)",
                                "0 0 12px rgba(101,179,46,0.7)",
                                "0 0 0px rgba(0,96,113,0)",
                              ],
                            }
                          : {}
