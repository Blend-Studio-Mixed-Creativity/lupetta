...
function MaterialCard({ iconPath, title, subtitle, desc, index, parentVisible }: ItemProps) {
  return (
    ...
    >
      ...
      >
        <div className="w-full min-h-[320px] sm:min-h-[380px] md:min-h-[460px] bg-[#0b1a20] rounded-[19px] p-6 sm:p-8 md:p-10 flex flex-col justify-center relative overflow-hidden">
