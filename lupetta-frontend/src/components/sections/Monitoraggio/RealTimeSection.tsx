  ...
  return (
    <section className="w-full bg-linear-to-br from-slate-50 via-white to-emerald-50/40 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28 lg:py-36 relative z-10">
        <div className="grid min-[960px]:grid-cols-[0.82fr_1.18fr] lg:grid-cols-2 gap-10 lg:gap-20 items-center">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="order-2 min-[960px]:order-1 lg:order-1 flex justify-center"
          >
            <div className="relative max-w-xl w-full group">
              ...
              <div className="relative rounded-3xl overflow-hidden border border-white/80 shadow-2xl bg-white p-3 transition-transform duration-500 group-hover:-translate-y-1">
                <img
                  ...
                  className="w-full aspect-[4/5] sm:aspect-[3/4] min-[960px]:aspect-[4/5] lg:aspect-[4/5] object-cover object-center rounded-2xl"
                />
                {/* Live badge */}
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="order-1 min-[960px]:order-2 lg:order-2"
          >
            ...
            <h2 className="text-3xl sm:text-4xl md:text-4xl lg:text-5xl text-slate-900 tracking-tight mt-5 mb-8 leading-tight">
              Monitoraggio <span className="montserrat-italic text-accent lg:whitespace-nowrap">in tempo reale</span>
            </h2>
