...
export default function HeroSection() {
  return (
    <section
      className="relative isolate overflow-hidden text-white min-h-[90vh] flex items-center justify-center animate-[bgRadialIn_1.5s_cubic-bezier(0.16,1,0.3,1)]"
    ...
    >
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-[#65b32e]/20 via-transparent to-transparent opacity-70 animate-pulse" />
      
      <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-32 sm:py-40 md:py-48 lg:py-56 text-center relative z-10">
        <span className="inline-block py-2.5 px-6 rounded-full bg-white/10 border border-white/30 text-white text-xs sm:text-sm font-bold tracking-[0.2em] uppercase mb-8 lg:mb-12 animate-slide-up shadow-[0_0_20px_rgba(255,255,255,0.2)] backdrop-blur-md">
        ...
        <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-[5.5rem] xl:text-[6.5rem] font-extrabold tracking-tighter leading-[1.05] mb-8 animate-scale-in animate-stagger-1 drop-shadow-2xl">
