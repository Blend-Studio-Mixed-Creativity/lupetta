...
export default function CtaSection() {
  return (
    <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-28 text-center">
      <RevealSection className="bg-gradient-to-br from-[#006473] to-[#00546b] rounded-3xl p-6 sm:p-8 md:p-12 lg:p-16 text-white relative overflow-hidden" animation="sr-reveal-scale">
        ...
        <div className="relative z-10">
          ...
          <Link to="/come-funziona" className="inline-block px-5 sm:px-8 py-3 sm:py-4 bg-[#62bc46] text-white font-bold rounded-2xl hover:bg-[#52a83d] transition-all shadow-xl text-lg animate-pulse-glow hover:scale-105 hover:shadow-2xl duration-300">
            Lorem Ipsum &rarr;
          </Link>
        </div>
      </RevealSection>
