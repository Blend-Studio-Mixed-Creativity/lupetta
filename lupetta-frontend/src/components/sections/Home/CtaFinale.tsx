...
export default function CtaFinale() {
  return (
    <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-28 text-center">
      <RevealSection
        className="bg-[#62bc46] rounded-3xl p-6 sm:p-8 md:p-12 lg:p-16 text-white relative overflow-hidden"
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link to="/come-funziona" className="px-5 sm:px-8 py-3 sm:py-4 bg-white text-[#62bc46] font-bold rounded-2xl hover:bg-slate-100 transition-all shadow-xl text-lg hover:scale-105 duration-300">
              Lorem Ipsum &rarr;
            </Link>
