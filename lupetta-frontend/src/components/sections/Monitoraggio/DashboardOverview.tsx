  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-16 relative z-20 pb-12 sm:pb-16 lg:pb-12 sm:pb-16 lg:pb-24">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {STATS.map((stat, i) => (
          <div key={i} className={`bg-white rounded-2xl shadow-md border border-slate-100 overflow-hidden card-hover animate-scale-in animate-stagger-${i + 1}`}>
            <div className="h-1 bg-gradient-to-r from-[#006473] to-[#62bc46]" />
            <div className="p-6 text-center">
              <div className="w-11 h-11 rounded-xl bg-[#006473]/10 flex items-center justify-center mx-auto mb-4">
