        ...
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-[#0d1f26] flex items-center justify-center border border-white/10">
                <div className="h-4 w-4 rounded-full bg-[#006071]/30 border border-[#006071]/50 p-2" />
              </div>
              <h3 className="hidden md:block text-xl md:pl-20 md:text-3xl font-bold text-white/40">
                {item.title}
              </h3>
            </div>
