export default function Gabbione() {
  return (
    <div className="bg-slate-50 min-h-screen overflow-hidden">
      ...
      {/* ═══ HERO ═══ */}
      <section className="relative bg-gradient-to-br from-purple-950 via-fuchsia-950 to-slate-900 text-white overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_70%_60%_at_40%_-20%,rgba(168,85,247,0.25),transparent)] pointer-events-none" />
        <div className="absolute bottom-0 left-0 right-0 h-24 bg-gradient-to-t from-slate-50 to-transparent" />

        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-36 text-center relative z-10">
          <span className="inline-block py-2 px-5 rounded-full bg-purple-500/10 border border-purple-400/30 text-purple-300 text-sm font-semibold tracking-widest uppercase mb-8 animate-fade-in">
            Gabbione
          </span>
          <h1 className="text-5xl md:text-6xl lg:text-7xl tracking-tight leading-[1.05] mb-8 animate-slide-up montserrat-italic">
            Soluzioni di<br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400">Contenimento</span>
          </h1>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-12 relative z-20 pb-24">
        <div className="text-center mb-14 animate-slide-up">
          <span className="text-purple-600 font-bold text-sm tracking-widest uppercase">Tipologie</span>
          <h2 className="text-3xl md:text-4xl text-slate-900 tracking-tight mt-3">
            Tipologie di Gabbioni <span className="montserrat-italic text-purple-600">Compatibili</span>
          </h2>
        </div>
          ...
          {[
            ...
            <div key={i} className={`bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden card-hover animate-slide-up animate-stagger-${i + 1}`}>
              <div className="bg-gradient-to-r from-purple-500/5 to-pink-500/5 p-8">
                ...
                <span className="text-xs font-bold text-purple-600 tracking-widest uppercase">{gab.subtitle}</span>
                ...
                <ul className="space-y-2">
                  {gab.features.map((f, j) => (
                    <li key={j} className="flex items-center gap-2 text-sm text-slate-600">
                      <span className="w-1.5 h-1.5 rounded-full bg-purple-500" /> {f}
                    </li>
                  ))}
                </ul>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="animate-slide-left">
              <span className="text-purple-600 font-bold text-sm tracking-widest uppercase">Installazione</span>
              <h2 className="text-3xl md:text-4xl text-slate-900 tracking-tight mt-3 mb-6">
                Montaggio e Integrazione con <span className="montserrat-italic text-purple-600">l&apos;Allattatrice</span>
              </h2>
                ...
                <div className="space-y-5">
                  {[
                    ...
                    <div key={i} className="flex items-center gap-4 bg-white/80 p-4 rounded-xl">
                      <span className="w-10 h-10 bg-purple-600 text-white rounded-full flex items-center justify-center font-bold text-sm flex-shrink-0">{s.step}</span>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div className="text-center mb-14 animate-slide-up">
          <span className="text-purple-600 font-bold text-sm tracking-widest uppercase">Normative</span>
          <h2 className="text-3xl md:text-4xl text-slate-900 tracking-tight mt-3">
            Sicurezza e <span className="montserrat-italic text-purple-600">Regolamentazioni</span>
          </h2>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            ...
            <div key={i} className={`p-8 rounded-2xl border border-slate-100 bg-white hover:border-purple-200 hover:shadow-lg transition-all card-hover animate-slide-up animate-stagger-${i + 1}`}>
              <span className="text-3xl block mb-3">{norm.icon}</span>
              <span className="text-xs font-bold text-purple-600 tracking-widest uppercase">{norm.subtitle}</span>
      ...
      <section className="bg-gradient-to-r from-purple-600 to-pink-600 py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white animate-scale-in">
          ...
          <button className="px-8 py-4 bg-white text-purple-700 font-bold rounded-2xl hover:bg-purple-50 transition-all shadow-xl text-lg">
            Lorem Ipsum &rarr;
          </button>
        </div>
      </section>
